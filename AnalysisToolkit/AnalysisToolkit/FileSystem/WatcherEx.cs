...
namespace AnalysisToolkit.FileSystem
{
    ...
    /// </summary>
    internal class WatcherExEventArgs
	{
		#region Properties
    ...
    /// <param name="e"></param>
    internal delegate void WatcherExEventHandler(object sender, WatcherExEventArgs e);
    ...
    /// </summary>
    internal class WatchersExList : List<FileSystemWatcherEx> { }
    ...
    /// </summary>
    internal class WatcherEx : IDisposable
	{
		#region Data Members
